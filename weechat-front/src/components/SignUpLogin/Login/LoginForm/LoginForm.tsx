...
export default function LoginForm({ formData, setFormData, onSubmit }: Props) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="flex justify-end">
        <button
          type="button"
          className="text-xs sm:text-sm md:text-base text-purple-400 hover:text-purple-300 transition"
        >
          Forgot password?
        </button>
      </div>
